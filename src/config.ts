const config = {
    auth: {
        PROD: {
            ...
            GitHubOauthRedirectUrl: 'https://buildapi.docs.microsoft.com/v1/Authorizations/github',
            ...
            AzureDevOpsRedirectUrl: 'https://buildapi.docs.microsoft.com/v1/Authorizations/vso',
            ...
            AADAuthRedirectUrl: 'https://buildapi.docs.microsoft.com/v1/Authorizations/aad'
        },
        PPE: {
