...
import { BuildInstantAllocated, BuildInstantReleased, BuildProgress, RepositoryInfoRetrieved, BuildTriggered, BuildFailed, BuildStarted, BuildSucceeded, BuildCanceled, CancelBuildTriggered, CancelBuildSucceeded, CancelBuildFailed, CredentialExpired, StartServerFailed } from '../common/loggingEvents';
...
export class BuildController {
    ...
    public async startDocfxLanguageServer(credential: Credential): Promise<void> {
        ...
        try {
            ...
            this._eventStream.post(new StartServerFailed(err));
            return;
        }
    }
